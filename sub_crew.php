                                ...
                                <div class="flipSide flipBack" data-title="TECHNICAL">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Marwan Wael.jpg" loading="lazy"
                                                alt="Marwan Wael" class="memberImage" />
                                        </div>
                        ...
                        <div class="flipCard smCard card1" data-aos="flip">
                            <div class="flipInner">
                                ...
                                <div class="flipSide flipBack" data-title="IT">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Mahmoud Alaam.jpg"
                                                alt="Mahmoud Alaam" class="memberImage" />
                                        </div>
                                        <div class="memberName">
                                            <h3>Mahmoud Allam</h3>
                                        </div>
                ...
                <div class="subCard" data-aos="fade-up" data-aos-delay="400">
                    <a href="crewDetails.php?committee_id=7" class="memberCardLink">
                        <div class="flipCard smCard card2" data-aos="flip">
                            <div class="flipInner">
                                <div class="flipSide flipFront"><img src="./assets/img/crew/backCardCrew.png" loading="lazy"
                                        alt="backCard" /></div>
                                <div class="flipSide flipBack" data-title="DD">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Mohamed El Hossiny.jpg"
                                                alt="Mohamed El Hossiny" class="memberImage" />
                                        </div>
                                        <div class="memberName">
                        ...
                        <div class="flipCard smCard card3" data-aos="flip">
                            <div class="flipInner">
                                ...
                                <div class="flipSide flipBack" data-title="MP">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Omar Ahmed.jpg" alt="Omar Ahmed"
                                                class="memberImage" />
                                        </div>
                                        <div class="memberName">
                                            <h3>Omar Ahmed</h3>
                        ...
                        <div class="flipCard smCard card4" data-aos="flip">
                            <div class="flipInner">
                                ...
                                <div class="flipSide flipBack" data-title="SMM">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Nour Mohamed.jpg"
                                                alt="Nour Mohamed" class="memberImage" />
                                        </div>
                                        <div class="memberName">
                                            <h3>Nour Mohamed</h3>
                                        </div>
                        ...
                        <div class="flipCard" data-aos="flip">
                            <div class="flipInner">
                                ...
                                <div class="flipSide flipBack" data-title="ER">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Mohamed Hesham.jpg"
                                                alt="Mohamed Hesham" class="memberImage" />
                                        </div>
                                        <div class="memberName">
            ...
            <div class="subCrewGrid activeGrid">
                ...
                <div class="subCard" data-aos="fade-up" data-aos-delay="300">
                    <a href="crewDetails.php?committee_id=4" class="memberCardLink">
                        <div class="flipCard smCard card1" data-aos="flip">
                            <div class="flipInner">
                                <div class="flipSide flipFront"><img src="./assets/img/crew/backCardCrew.png"
                                        loading="lazy"></div>
                                <div class="flipSide flipBack" data-title="BD">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Omar Hesham.jpg" alt="Omar Hesham"
                                                class="memberImage" />
                                        </div>
                                        <div class="memberName">
                                            <h3>Omar Hesham</h3>
                        ...
                        <div class="flipCard smCard card2" data-aos="flip">
                            <div class="flipInner">
                                ...
                                <div class="flipSide flipBack" data-title="LOGISTICS">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Asser El-Sayed.jpg"
                                                alt="Asser El-Sayed" class="memberImage" />
                                        </div>
                                        <div class="memberName">
                        ...
                        <div class="flipCard smCard card3" data-aos="flip">
                            <div class="flipInner">
                                ...
                                <div class="flipSide flipBack" data-title="CR">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Belal Omar.jpg" alt="Belal Omar"
                                                class="memberImage" />
                                        </div>
                                        <div class="memberName">
                                            <h3>Belal Omar</h3>
                        ...
                        <div class="flipCard smCard card4" data-aos="flip">
                            <div class="flipInner">
                                ...
                                <div class="flipSide flipBack" data-title="PR">
                                    <div class="backCard">
                                        <div class="memberImageContainer">
                                            <img src="./assets/uploadedImages/SCCI Board/Yasmine Gawish.jpg"
                                                alt="Yasmine Gawish" class="memberImage" />
                                        </div>
                                        <div class="memberName">
